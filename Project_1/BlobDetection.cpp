...
double inproduct(cv::Mat row, Mat col)
{
...
_int16 getEntryNeighbour(const Mat& admin, int x, int y, int nr)
{
	switch (nr)
	{
	case 0: return getEntryImage(admin, x - 1, y);
		break;
	case 1: return getEntryImage(admin, x - 1, y + 1);
		break;
	case 2: return getEntryImage(admin, x, y + 1);
		break;
	case 3: return getEntryImage(admin, x + 1, y + 1);
		break;
	case 4: return getEntryImage(admin, x + 1, y);
		break;
	case 5: return getEntryImage(admin, x + 1, y - 1);
		break;
	case 6: return getEntryImage(admin, x, y - 1);
		break;
	case 7: return getEntryImage(admin, x - 1, y - 1);
		break;
